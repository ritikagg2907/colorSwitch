...
public class Cross extends Obstacles{
    ...
    public Cross(float cx, float cy, float len, float width) {
        this.setCx(cx);
        this.setCy(cy);
        this.setLen(len);
        this.setWidth(width);
    ...
    public Group createObstacle() {
        ...
        l1.setEndY(this.getCy()-this.getLen());
        ...
        l2.setEndX(this.getCx()+this.getLen());
